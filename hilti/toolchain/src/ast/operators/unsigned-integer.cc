    ...
    Signature signature(Builder* builder) const final {
        return {
            ...
            .op1 = {parameter::Kind::In,
                    builder->typeType(builder->qualifiedType(builder->typeUnsignedInteger(type::Wildcard()), true))},
            .result_doc = "int<*>",
            .ns = "unsigned_integer",
...
public:
    Signature signature(Builder* builder) const final {
        return {
            ...
            .op0 = {parameter::Kind::In, builder->typeUnsignedInteger(type::Wildcard())},
            .op1 = {parameter::Kind::In,
                    builder->typeType(builder->qualifiedType(builder->typeSignedInteger(type::Wildcard()), true))},
            .result_doc = "uint<*>",
            .ns = "unsigned_integer",
...
public:
    Signature signature(Builder* builder) const final {
        return {
            .kind = Kind::Cast,
            .op0 = {parameter::Kind::In, builder->typeUnsignedInteger(type::Wildcard())},
            .op1 = {parameter::Kind::In, builder->typeType(builder->qualifiedType(builder->typeReal(), true))},
...
public:
    Signature signature(Builder* builder) const final {
        return {
            .kind = Kind::Cast,
            .op0 = {parameter::Kind::In, builder->typeUnsignedInteger(type::Wildcard())},
            .op1 = {parameter::Kind::In, builder->typeType(builder->qualifiedType(builder->typeInterval(), true))},
...
public:
    Signature signature(Builder* builder) const final {
        return {
            .kind = Kind::Cast,
            .op0 = {parameter::Kind::In, builder->typeUnsignedInteger(type::Wildcard())},
            .op1 = {parameter::Kind::In, builder->typeType(builder->qualifiedType(builder->typeTime(), true))},
...
public:
    Signature signature(Builder* builder) const final {
        return {
            .kind = Kind::Cast,
            .op0 = {parameter::Kind::In, builder->typeUnsignedInteger(type::Wildcard())},
            .op1 = {parameter::Kind::In, builder->typeType(builder->qualifiedType(builder->typeBool(), true))},
            .result = {Const, builder->typeBool()},
            .ns = "unsigned_integer",
