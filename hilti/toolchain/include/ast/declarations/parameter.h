...
public:
    ...
    auto isResolved() const { return type()->isResolved(); }
    ...
    static auto create(ASTContext* ctx, ID id, const UnqualifiedTypePtr& type, parameter::Kind kind,
        ...
        return NodeDerivedPtr<Parameter>(new Parameter(ctx, {_qtype(ctx, type, kind), default_, attrs}, std::move(id),
...
private:
    static QualifiedTypePtr _qtype(ASTContext* ctx, const UnqualifiedTypePtr& t, parameter::Kind kind) {
        switch ( kind ) {
            case parameter::Kind::Copy: return QualifiedType::create(ctx, t, false, Side::LHS, t->meta());
            case parameter::Kind::In: return QualifiedType::create(ctx, t, true, Side::RHS, t->meta());
            case parameter::Kind::InOut: return QualifiedType::create(ctx, t, false, Side::LHS, t->meta());
            default: return QualifiedType::create(ctx, type::Unknown::create(ctx), true, Side::RHS, t->meta());
        }
    }
