...
public:
    ...
    static auto create(ASTContext* ctx, const QualifiedTypePtr& result, const declaration::Parameters& params,
        ...
        return NodeDerivedPtr<Function>(new Function(ctx, flatten(result, params), flavor, meta));
    }

    static auto create(ASTContext* ctx, Wildcard _, const Meta& m = Meta()) {
        return NodeDerivedPtr<Function>(
            new Function(ctx, Wildcard(), {QualifiedType::create(ctx, type::Unknown::create(ctx, m), true)}, m));
    }
