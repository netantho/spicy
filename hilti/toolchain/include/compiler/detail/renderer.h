...
namespace hilti::detail::renderer {
 ...
 *        scope
 */
void render(std::ostream& out, const NodePtr& node, bool include_scopes = false);
 ...
 *        scope
 */
void render(logging::DebugStream stream, const NodePtr& node, bool include_scopes = false);
